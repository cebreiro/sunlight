...
namespace sunlight::sox
{
    struct MonsterPart2
    {
        explicit MonsterPart2(StreamReader<std::vector<char>::const_iterator>& reader);
        ...
        int32_t attack1fx = {};
        int32_t attack1abnormality = {};
        int32_t attack1abnormalityDuration = {};
        int32_t attack1abnormalityProbmod = {};
        int32_t attack1abnormalityReserved1 = {};
        int32_t attack1abnormalityReserved2 = {};
        ...
        int32_t attack2fx = {};
        int32_t attack2abnormality = {};
        int32_t attack2abnormalityDuration = {};
        int32_t attack2abnormalityProbmod = {};
        int32_t attack2abnormalityReserved1 = {};
        int32_t attack2abnormalityReserved2 = {};
        ...
        int32_t attack3fx = {};
        int32_t attack3abnormality = {};
        int32_t attack3abnormalityDuration = {};
        int32_t attack3abnormalityProbmod = {};
        int32_t attack3abnormalityReserved1 = {};
        int32_t attack3abnormalityReserved3 = {};
        ...
        int32_t attack4fx = {};
        int32_t attack4abnormality = {};
        int32_t attack4abnormalityDuration = {};
        int32_t attack4abnormalityProbmod = {};
        int32_t attack4abnormalityReserved1 = {};
        int32_t attack4abnormalityReserved4 = {};
    ...
    class MonsterPart2Table final : public ISoxTable, public std::enable_shared_from_this<MonsterPart2Table>
    {
    public:
    ...
    private:
        std::unordered_map<int32_t, MonsterPart2*> _umap;
