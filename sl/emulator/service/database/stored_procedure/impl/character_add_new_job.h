...
{
    class CharacterAddNewJob final : public StoredProcedure
    {
    public:
        CharacterAddNewJob(ConnectionPool::Borrowed& conn, int64_t cid, int32_t job, int32_t jobType, int32_t level, int32_t skillPoint,
