...
namespace sunlight
{
    AuthenticationToken::Key::Key(int32_t low, int32_t high)
        : _low(low)
        , _high(high)
    {
    }

    auto AuthenticationToken::Key::GetLow() const -> int32_t
    {
        return _low;
    }

    auto AuthenticationToken::Key::GetHigh() const -> int32_t
    {
        return _high;
    }
