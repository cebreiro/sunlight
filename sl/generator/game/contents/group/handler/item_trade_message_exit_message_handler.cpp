#include "item_trade_message_exit_message_handler.h"
...
namespace sunlight
{
    void ItemTradeExitMessageHandler::Handle(PlayerGroupSystem& system, GameGroup& group, GamePlayer& player, SlPacketReader& reader) const
    {
        (void)reader;
