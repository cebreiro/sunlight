...
namespace sunlight
{
    ...
    auto ZoneDataTransferObjectCreator::CreatePlayerInformation(const GamePlayer& player) -> Buffer
    {
        ...
        writer.Write<int32_t>(statComponent.GetStatValue(RecoveryStatType::HP).As<int32_t>());
        writer.Write<int32_t>(statComponent.GetStatValue(RecoveryStatType::SP).As<int32_t>());
        writer.Write<int32_t>(statComponent.GetStat(PlayerStatType::Str).Get(StatOriginType::Base).As<int32_t>());
        writer.Write<int32_t>(statComponent.GetStat(PlayerStatType::Dex).Get(StatOriginType::Base).As<int32_t>());
        writer.Write<int32_t>(statComponent.GetStat(PlayerStatType::Accr).Get(StatOriginType::Base).As<int32_t>());
        writer.Write<int32_t>(statComponent.GetStat(PlayerStatType::Health).Get(StatOriginType::Base).As<int32_t>());
        writer.Write<int32_t>(statComponent.GetStat(PlayerStatType::Intell).Get(StatOriginType::Base).As<int32_t>());
        writer.Write<int32_t>(statComponent.GetStat(PlayerStatType::Wisdom).Get(StatOriginType::Base).As<int32_t>());
        writer.Write<int32_t>(statComponent.GetStat(PlayerStatType::Will).Get(StatOriginType::Base).As<int32_t>());
        writer.Write<int32_t>(0);
        writer.Write<int32_t>(statComponent.GetStat(PlayerStatType::Fire).Get(StatOriginType::Base).As<int32_t>());
        writer.Write<int32_t>(statComponent.GetStat(PlayerStatType::Water).Get(StatOriginType::Base).As<int32_t>());
        writer.Write<int32_t>(statComponent.GetStat(PlayerStatType::Lightning).Get(StatOriginType::Base).As<int32_t>());
