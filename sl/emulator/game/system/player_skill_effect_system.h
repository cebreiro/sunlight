...
namespace sunlight
{
    ...
    private:
        bool Apply(GamePlayer& player, const IPassiveEffect& passiveEffect, int32_t skillLevel) const;
        bool Revert(GamePlayer& player, const IPassiveEffect& passiveEffect, int32_t skillLevel) const;
